...
--
-- Host: localhost
-- Generation Time: Mar 14, 2019 at 05:06 AM
...
(3, 'SOD', 'my one', 1, '2019-03-13 08:56:20', '1', 1, 1);
...
CREATE TABLE IF NOT EXISTS `prod_rating` (
  `prod_rating_id` int(10) NOT NULL,
  `product_id` int(4) NOT NULL,
  `rating_id` int(1) NOT NULL,
...
(1, 'rkd', 'durai', 'Rathakrishnna', 'Duraimoni', 1, '2019-02-27 02:08:50', 'd.rathakrishnan@gmail.com'),
(3, 'rksd', 'durai', 'Rathakrishnna', 'Duraimondi', 1, '2019-02-27 02:10:01', ''),
(5, 'sure', 'durai', 'Rathakrishnna', 'Duraimondi', 1, '2019-02-27 02:13:12', ''),
(13, 'd', 'durai', 'Rathakrishnna', 'Duraimondi', 1, '2019-02-27 02:28:03', ''),
...
--
ALTER TABLE `domain`
  ADD CONSTRAINT `domain_ibfk_1` FOREIGN KEY (`domain_leader`) REFERENCES `user` (`user_id`);
...
ALTER TABLE `prod_rating`
  ADD CONSTRAINT `prod_rating_ibfk_2` FOREIGN KEY (`rating_id`) REFERENCES `rating` (`rating_id`),
  ADD CONSTRAINT `prod_rating_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `product` (`product_id`);
